...
//       content:
//         "If you exit this exam, unanswered questions will count as failed.",
//       async onOk() {
//         await submitExam();
...
//       },
//     });
//   }, [submitExam, setIndex, exams.length]);
...
//     [examContext.mode, showAns, handleAns, exam._id]
//   );
...
//                 <hr />
//                 <p>if you need other payment methods, contact us</p>
//               </div>
//             )}
//           </div>
//         </div>
...
//               </span>
//             )}
//             <Button onClick={(e) => ansFun(e, exam._id, index)}>
//               {index < exams.length - 1
//                 ? showAns
//                   ? "Next Question"
//                   : "Next"
